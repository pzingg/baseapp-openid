...
Rails::Initializer.run do |config|
  ...
  config.gem 'configatron',    :version => '>= 2.2'
  config.gem 'authlogic',      :version => '>= 1.4'
  ...
  config.gem 'jcnetdev-better_partials', :version => '>= 1.1',
  ...
  config.action_controller.session = {
    :session_key => '_accountmgr_session',
    :secret      => '92e42086b6c3c3f5ecb69435938aba062592577f2401201bca15891739cab27857b0d6ccc05c06eaeef2b8e43d94addd1da56d729d2416173885d0a6a295bd32'
  }
